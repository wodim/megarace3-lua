...
#------------ Virages ---------------------------------------------------------------------------------
StrafeTourneCoef			6500		#Différentiel sur les réacteurs de poussée
AmortissementRotationZ			6.8			
...
StrafeBasculeCoef			43800			#Pousse sur la boîte réelle; effet d'accompagner le virage
...
VitesseDeDerapage			40.5		#si cette vitesse latérale est atteinte (en km/h), on commence à déraper
