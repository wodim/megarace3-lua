...
-- Function 'Init'
function CMU_LINE_CHAT_04:Init()
end

-- Function 'Update'
function CMU_LINE_CHAT_04:Update()

	local line = ""
	local fromMe = FALSE
	if GetChatLineAt(cmuL1 + 3)~=nil then
		line = line..GetChatLineAt(cmuL1 + 3)
		fromMe = IsLocalChatLine(cmuL1 + 3)
	end
