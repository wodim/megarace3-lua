...
function xb:Init()
	...
	LoadPodProperties("CURRENT","Pods\\Xb\\Xb_Properties.ini")
	LoadPodCombo("CURRENT")
	LoadPodConfig("CURRENT")
	SavePodProperties("CURRENT")

	NotifyToEntity( "CURRENT", TE_SET_LIFE, -1)
	NotifyToEntity( "CURRENT", TE_SET_ENERGIE, 0)
...
function xb:Fnc2()
	-- vue interne
	setCameraPositionInMode( 0, 0, 1.6, 0 )
	setCameraTargetInMode( 0, -16, 0, 0 )
