...
#------------ Deflagration ----------------------------------------------------------------------------
DeflagIntensite				0
DeflagRepulsionIntensite	0
DeflagRayonDAction			0
DeflagDuree					0			#en ms
...
FlagSurviveToCollision			1	#Indique si le missile survit a un choc avec kk1 d'autre (genre smoke)
