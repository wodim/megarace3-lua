...
#------------ Virages ---------------------------------------------------------------------------------
StrafeTourneCoef			10900		#Différentiel sur les réacteurs de poussée
AmortissementRotationZ			6.2			


#Paramètres qui agit sur le temps de réaction du vaisseau par rapport au touche/paddle#
FacteurMax				1.5			#		si val> tourne +/tps 
TempsMax				130			#En ms		Si tps> tourne +vite
