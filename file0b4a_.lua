...
#------------ Acceleration ----------------------------------------------------------------------------
VitesseMax			500 #420				#Vitesse maximum
coefAccel			0.7 #0.4
coefDecel			0.75
...
#------------ Virages ---------------------------------------------------------------------------------
StrafeTourneCoef			12000 #9400		#Différentiel sur les réacteurs de poussée
...
FacteurDeVitesse			0.00005		#+ ce facteur est élevé, - la prise de virage est rapide.

VirageFacteur				10
VirageTemps					100

StrafeBasculeCoef			41800			#Pousse sur la boîte réelle; effet d'accompagner le virage
AmortissementRotationY			100000000000000000


#------------ Derapages -------------------------------------------------------------------------------
CoeffDeGrip				0.3 #0.1			#adherence en temps normal du pod: 0=pas d'aherence 1=adherence max,pas de glissade
VitesseDeDerapage			80.5		#si cette vitesse latérale est atteinte (en km/h), on commence à déraper
CoeffDeDerapage				0.01				#adherence en temps slide du pod: 0=pas d'aherence 1=adherence max,pas de glissade
CoeffDeDerapageReboost		0.45				#reprise (puissance moteur)

#------------ Aerofreins ------------------------------------------------------------------------------
AerofreinCoef				42800		#Aerofrein brutal quand les 2 cotes sont actives
AerofreinCoteCoef			13200		#Aerofrein de cote
AerofreinCoteFacteur		2			#force du contre virage
AerofreinCoteTemps			99		#temps pour contre virage en millisec
...
CoefChocConstant			0.3		#Pourcentage de perte de vitesse suite à un choc
CoefChocAngle				0.15		#Pourcentage identique au précédent et proportionnel à l'angle du choc
