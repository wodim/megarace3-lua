SpineBee5={ missileSFX, explosionSFX }

function SpineBee5:Init()
	self.missileSFX = GetEntityName() .. "reactor"
	self.explosionSFX = GetEntityName() .. "explosion"

	loadSFX( "CURRENT", self.missileSFX, "sfx_missile6" )
...
function SpineBee5:End()
end

function SpineBee5:Fnc1()
