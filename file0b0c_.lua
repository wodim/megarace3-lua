...
#------------ Ressorts de liaison ---------------------------------------------------------------------
RessortRaideur				0.5	#1
RessortAmmortissement		0.8	#0.1
...
#------------ Acceleration ----------------------------------------------------------------------------
VitesseMax			430				#Vitesse maximum
coefAccel			0.48
coefDecel			0.90
...
#------------ Virages ---------------------------------------------------------------------------------
StrafeTourneCoef			10500		#Différentiel sur les réacteurs de poussée
AmortissementRotationZ			4.8			


#Paramètres qui agit sur le temps de réaction du vaisseau par rapport au touche/paddle#
FacteurMax				1.8			#		si val> tourne +/tps 
TempsMax				150			#En ms		Si tps> tourne +vite

#Courbe de modification de prise de virage en fonction de la vitesse
FacteurDeVitesse			0.00000001		#+ ce facteur est élevé, - la prise de virage est rapide.

VirageFacteur				12
VirageTemps					120

StrafeBasculeCoef			10000			#Pousse sur la boîte réelle; effet d'accompagner le virage
...
VitesseDeDerapage			350		#si cette vitesse latérale est atteinte (en km/h), on commence à déraper
CoeffDeDerapage				0.9				#adherence en temps slide du pod: 0=pas d'aherence 1=adherence max,pas de glissade
CoeffDeDerapageReboost		0.4				#reprise (puissance moteur)

#------------ Aerofreins ------------------------------------------------------------------------------
AerofreinCoef				90000		#Aerofrein brutal quand les 2 cotes sont actives
AerofreinCoteCoef			20000		#Aerofrein de cote
AerofreinCoteFacteur		2.5			#force du contre virage
AerofreinCoteTemps			140		#temps pour contre virage en millisec

VitesseMaxVerticale			100				#Vitesse seuil du pod en hauteur, permet de detecter si on va decoller
RalentissementMaxVerticale	0.5				#Coefficient de ralentissement si on dépasse la vitesse seuil

AngleDeToleranceSurTube		55				#Angle de tolerance avant l'assistance de conduite sur tube
VitesseDeToleranceSurTube	170				#Vitesse de tolerance avant l'assistance de conduite sur tube
