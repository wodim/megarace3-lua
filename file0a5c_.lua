...
FacteurMax				0.09			#		si val> tourne +/tps 
...
#------------ Derapages -------------------------------------------------------------------------------
CoeffDeGrip				0.08			#adherence en temps normal du pod: 0=pas d'aherence 1=adherence max,pas de glissade
VitesseDeDerapage			150.5		#si cette vitesse latérale est atteinte (en km/h), on commence à déraper
...
#------------ Aerofreins ------------------------------------------------------------------------------
AerofreinCoef				35800		#Aerofrein brutal quand les 2 cotes sont actives
AerofreinCoteCoef			11400		#Aerofrein de cote
