Gazelles_Power_sfx={module3_leftsfx, module3_midsfx, module3_rightsfx, reactorLsfx, reactorRsfx, reactorMsfx}

function Gazelles_Power_sfx:Init()
	ChargeSon("Speed1")
...
function Gazelles_Power_sfx:ReInit()
...
function Gazelles_Power_sfx:Update()
end

function Gazelles_Power_sfx:End()
end

function Gazelles_Power_sfx:Fnc1()
...
function Gazelles_Power_sfx:Fnc2()
...
function Gazelles_Power_sfx:KillSfx()
	stopSFX( self.module3_leftsfx )
	stopSFX( self.module3_midsfx )
	stopSFX( self.module3_rightsfx )
	stopSFX( self.reactorLsfx )
