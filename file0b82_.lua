o3d_insext06={module1SFX, enable, trig, impact, fx_impact}

function o3d_insext06:Init()
	self.module1SFX = GetEntityName() .. "insext"
	loadSFX( "CURRENT", self.module1SFX, "sfx_insext" )
	startSFX( self.module1SFX )
	
	self.enable = FALSE
	self.trig = "t_impact_insext06"
	self.impact = "o3d_impact_insext06"
...
function o3d_insext06:End()

end


function o3d_insext06:Notify(event)
...
function o3d_insext06:Clock(id)
	if id == 0 then
		self.enable = FALSE
	end
end