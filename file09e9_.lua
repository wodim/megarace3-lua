...
#------------ Acceleration ----------------------------------------------------------------------------
VitesseMax			425				#Vitesse maximum
coefAccel			0.4
coefDecel			0.75
...
#------------ Virages ---------------------------------------------------------------------------------
StrafeTourneCoef			9400		#Différentiel sur les réacteurs de poussée
AmortissementRotationZ			7.8			


#Paramètres qui agit sur le temps de réaction du vaisseau par rapport au touche/paddle#
FacteurMax				0.9			#		si val> tourne +/tps 
TempsMax				180			#En ms		Si tps> tourne +vite

#Courbe de modification de prise de virage en fonction de la vitesse
FacteurDeVitesse			0.000005		#+ ce facteur est élevé, - la prise de virage est rapide.
