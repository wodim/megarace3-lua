...
StrafeBasculeCoef			3000			#Pousse sur la boîte réelle; effet d'accompagner le virage
AmortissementRotationY			100000000000000000


#------------ Derapages -------------------------------------------------------------------------------
CoeffDeGrip				0.95			#adherence en temps normal du pod: 0=pas d'aherence 1=adherence max,pas de glissade
VitesseDeDerapage			200		#si cette vitesse latérale est atteinte (en km/h), on commence à déraper
CoeffDeDerapage				0.001				#adherence en temps slide du pod: 0=pas d'aherence 1=adherence max,pas de glissade
CoeffDeDerapageReboost		0.4				#reprise (puissance moteur)

#------------ Aerofreins ------------------------------------------------------------------------------
AerofreinCoef				25000		#Aerofrein brutal quand les 2 cotes sont actives
AerofreinCoteCoef			10500		#Aerofrein de cote
...
JumpStrafeBasculeCoef			80000			#Pousse sur la boîte réelle; effet d'accompagner le virage
