...
#------------ Acceleration ----------------------------------------------------------------------------
VitesseMax			500				#Vitesse maximum
coefAccel			0.7
coefDecel			0.75
...
#------------ Virages ---------------------------------------------------------------------------------
StrafeTourneCoef			9500		#Différentiel sur les réacteurs de poussée
AmortissementRotationZ			9.8			


#Paramètres qui agit sur le temps de réaction du vaisseau par rapport au touche/paddle#
FacteurMax				0.5			#		si val> tourne +/tps 
TempsMax				400			#En ms		Si tps> tourne +vite
