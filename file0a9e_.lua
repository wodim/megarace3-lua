Scale_of_Blade_sfx={module3_leftsfx, module3_midsfx, module3_rightsfx, reactorLsfx, reactorRsfx, reactorMsfx}

function Scale_of_Blade_sfx:Init()
	ChargeSon("Speed1")
...
function Scale_of_Blade_sfx:ReInit()
...
function Scale_of_Blade_sfx:Update()
end

function Scale_of_Blade_sfx:End()
end

function Scale_of_Blade_sfx:Fnc1()
...
function Scale_of_Blade_sfx:Fnc2()
...
function Scale_of_Blade_sfx:KillSfx()
	stopSFX( self.module3_leftsfx )
	stopSFX( self.module3_midsfx )
	stopSFX( self.module3_rightsfx )
	stopSFX( self.reactorLsfx )
