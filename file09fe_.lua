...
#------------ Derapages -------------------------------------------------------------------------------
CoeffDeGrip				0.081			#adherence en temps normal du pod: 0=pas d'aherence 1=adherence max,pas de glissade
...
CoeffDeDerapageReboost		0.6				#reprise (puissance moteur)

#------------ Aerofreins ------------------------------------------------------------------------------
AerofreinCoef				38000		#Aerofrein brutal quand les 2 cotes sont actives
