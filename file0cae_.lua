Dummy_Globule_Norm={visible, enable}


function Dummy_Globule_Norm:Init()
...
function Dummy_Globule_Norm:Update()
...
function Dummy_Globule_Norm:End()
end


function Dummy_Globule_Norm:Notify(event)
