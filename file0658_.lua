SpineBee4={ missileSFX, explosionSFX }

function SpineBee4:Init()
	self.missileSFX = GetEntityName() .. "reactor"
	self.explosionSFX = GetEntityName() .. "explosion"

	loadSFX( "CURRENT", self.missileSFX, "sfx_missile5" )
...
function SpineBee4:End()
end

function SpineBee4:Fnc1()
