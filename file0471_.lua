...
-- Function 'Init'
function CMU_LINE_CHAT_01:Init()
end

-- Function 'Update'
function CMU_LINE_CHAT_01:Update()

	local line = ""
	local fromMe = FALSE
	if GetChatLineAt(cmuL1)~=nil then
		line = line..GetChatLineAt(cmuL1)
		fromMe = IsLocalChatLine(cmuL1)
	end
