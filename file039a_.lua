...
function C2lua:Init()
	...
	if GetCSMode() == 0 then
	-- carriere 1
		CreatePodIa ("Hyper-Ion","hy.dff", "hy",1 , "Module01"  ,"Module02"  ,"Module03"  , "IA_Neutre"  , "moden" ,-36)
		CreatePodIa ("X-tra Bee","xb.dff", "xb", 2, "Module01"  ,"Module02" , "Module03"  , "IA_Defense" , "moded" ,-2)
		CreatePodIa ("Manta-Ray","mr.dff", "mr", 3, "Module01"  ,"Module02" , "Module03"  , "IA_Attaque"   , "modea" ,-27)
		CreatePodIa ("NanoTriton","nt.dff", "nt", 4 ,"Module01"  ,"Module02" , "Module03"  , "IA_Neutre"    , "moden",2)
		CreatePodIa ("Wotan","wo.dff", "wo",5 , "Module01"  ,"Module02" , "Module03"  , "IA_Neutre"    , "moden",-9)
		CreatePodIa ("Tri-Nyx","tn.dff", "tn",6 , "Module01"  ,"Module02" , "Module03"  , "IA_Neutre"    , "moden",-38)
		CreatePodIa ("G-Cricket","gc.dff", "gc",7 , "Module01"  ,"Module02" , "Module03"  , "IA_Neutre"    , "moden",-28)
		SetPodIaRatrappage("Hyper-Ion" , 10 , 5 )
		SetPodIaRatrappage("X-tra Bee" , 10 , 5 )
		SetPodIaRatrappage("Manta-Ray" , 10 , 5 )
		SetPodIaRatrappage("NanoTriton" , 10 , 5 )
		SetPodIaRatrappage("Wotan" , 10 , 5 )
		SetPodIaRatrappage("Tri-Nyx" , 10 , 5 )
		SetPodIaRatrappage("G-Cricket" , 10 , 5 )
	else
	-- Carriere 2
		CreatePodIa ("Hyper-Ion","hy.dff", "hy",1 , "Module01"  ,"Module02"  ,"Module03"  , "IA_Neutre"  , "moden" ,-24)
		CreatePodIa ("X-tra Bee","xb.dff", "xb", 2, "Module01"  ,"Module02" , "Module03"  , "IA_Defense" , "moded" ,8)
		CreatePodIa ("Manta-Ray","mr.dff", "mr", 3, "Module01"  ,"Module02" , "Module03"  , "IA_Attaque"   , "modea" ,-15)
		CreatePodIa ("NanoTriton","nt.dff", "nt", 4 ,"Module01"  ,"Module02" , "Module03"  , "IA_Neutre"    , "moden",10)
		CreatePodIa ("Wotan","wo.dff", "wo",5 , "Module01"  ,"Module02" , "Module03"  , "IA_Neutre"    , "moden",1)
		CreatePodIa ("Tri-Nyx","tn.dff", "tn",6 , "Module01"  ,"Module02" , "Module03"  , "IA_Neutre"    , "moden",-32)
		CreatePodIa ("G-Cricket","gc.dff", "gc",7 , "Module01"  ,"Module02" , "Module03"  , "IA_Neutre"    , "moden",-16)
		SetPodIaRatrappage("Hyper-Ion" , 8 , 12 )
		SetPodIaRatrappage("X-tra Bee" , 8 , 12 )
		SetPodIaRatrappage("Manta-Ray" , 8 , 12 )
		SetPodIaRatrappage("NanoTriton" , 8 , 12 )
		SetPodIaRatrappage("Wotan" , 8 , 12 )
...
function C2lua:Notify(event,param)
...
function C2lua:Clock(Id)
	...
	if self.win==0 then
		...
		if GetPodClassement("Player1") == 1 then
			if GetCSMode() == 0 then
				SetGlobalVariable("GainCar",1)
			else
				SetGlobalVariable("GainCar",3)
			end
		end
		WinRace()
	end
