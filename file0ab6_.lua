Damocles_Vampires_Sign_Sharks_Power={}

function Damocles_Vampires_Sign_Sharks_Power:Init()
	-- Bonus / Malus :
...
function Damocles_Vampires_Sign_Sharks_Power:Update()
end

function Damocles_Vampires_Sign_Sharks_Power:End()
end
