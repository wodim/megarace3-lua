...
#------------ MissileLocké ----------------------------------------------------------------------------
TempsDAttenteLock			1	#Temps de latence avant que l'autoguidage ne s'effectue (en s)

#------------ Vie du Missile ----------------------------------------------------------------------------
TempsDeVieMaximum			10	#Temps maximal que pourra vivre un missile (en ms) (0 =tps infini)
...
CoefChocConstant			0.7		#Pourcentage de perte de vitesse suite à un choc
CoefChocAngle				0.3		#Pourcentage identique au précédent et proportionnel à l'angle du choc
