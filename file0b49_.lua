...
#------------ Virages ---------------------------------------------------------------------------------
StrafeTourneCoef			6300		#Différentiel sur les réacteurs de poussée
...
TempsMax				250			#En ms		Si tps> tourne +vite

#Courbe de modification de prise de virage en fonction de la vitesse
FacteurDeVitesse			0.005		#+ ce facteur est élevé, - la prise de virage est rapide.
...
VitesseDeDerapage			115		#si cette vitesse latérale est atteinte (en km/h), on commence à déraper
...
AerofreinCoteCoef			15000		#Aerofrein de cote
