o3d_insext04={module1SFX, enable, trig, impact, fx_impact}

function o3d_insext04:Init()
	self.module1SFX = GetEntityName() .. "insext"
	loadSFX( "CURRENT", self.module1SFX, "sfx_insext" )
	startSFX( self.module1SFX )
	
	self.enable = FALSE
	self.trig = "t_impact_insext04"
	self.impact = "o3d_impact_insext04"
	self.fx_impact = "fx_impact3"
...
function o3d_insext04:End()

end


function o3d_insext04:Notify(event)
...
function o3d_insext04:Clock(id)
	if id == 0 then
		self.enable = FALSE
	end
end